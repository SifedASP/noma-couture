import { Container, Title, Grid, Flex, Text, ThemeIcon, Accordion, Checkbox, UnstyledButton, Stack, Center, Image, Button, Drawer, Group } from '@mantine/core';
...
import { IconAdjustmentsHorizontal, IconChevronRight } from '@tabler/icons-react';
...
const ProductArchive = () => {
    ...
    const largeScreen = useMediaQuery('(max-width: 1440px)');
            ...
            <Container fluid >
                ...
                <Container maw={'1180px'}>
                    <Grid>
                        ...
                        {
                            !smallScreen && (
                                <Grid.Col span={smallScreen ? 12 : tabletScreen ? 4 : 3} style={{ borderRight: '1px solid #0D1759' }}>

                                    <Container m={0} py={'xl'} style={{ borderBottom: '1px solid #0D1759' }}>
                                        <Title order={3}>Category</Title>

                                        <Container>
                                            <Stack align={'left'} gap={'xs'} mt={'xs'}>
                                                <UnstyledButton variant='subtle' w={'fit-content'} onClick={() => setCategory('Tops')}>
                                                    <Text fw={category === 'Tops' ? 'bold' : ''}>Tops</Text>
                                                </UnstyledButton>
                                                <UnstyledButton variant='subtle' w={'fit-content'} onClick={() => setCategory('Bottoms')}>
                                                    <Text fw={category === 'Bottoms' ? 'bold' : ''}>Bottoms</Text>
                                                </UnstyledButton>
                        ...
                        <Grid.Col span={smallScreen ? 12 : tabletScreen ? 8 : 9}>
                            ...
                            <Flex py="md" style={{ textWrap: 'wrap' }}>
                                <Group size='xs'><Text size='xs' c={'dimmed'}>Shop</Text>
                                    <ThemeIcon size='13px' variant='subtle'><IconChevronRight /></ThemeIcon> <Text c={'dimmed'} size='xs'>Category</Text>
                                    <ThemeIcon size='13px' variant='subtle'><IconChevronRight /></ThemeIcon> <Text size='xs'>{category}</Text>
                                </Group>
                            </Flex>
                                        ...
                                        <Drawer opened={opened} onClose={close} title="Filters">
                                            <Grid.Col span={smallScreen ? 12 : tabletScreen ? 4 : 3} style={{ borderRight: '0' }}>
                                                ...
                                                <Container m={0} py={'xl'} bg={'#fff'} style={{ borderBottom: '1px solid #1E1E1ECC' }}>
                                                    ...
                                                    <Container bg={'#fff'}>
                                                        <Stack align={'left'} gap={'xs'} mt={'xs'}>
                                                            <UnstyledButton variant='subtle' w={'fit-content'} onClick={() => handleCategory('Tops')}>
                                                                <Text fw={category === 'Tops' ? 'bold' : ''}>Tops</Text>
                                                            </UnstyledButton>
                                                            <UnstyledButton variant='subtle' w={'fit-content'} onClick={() => handleCategory('Bottoms')}>
                                                                <Text fw={category === 'Bottoms' ? 'bold' : ''}>Bottoms</Text>
                                                            </UnstyledButton>
